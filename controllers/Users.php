...
class Users extends Admin_Controller 
{
	...
	public function index()
	{
		...
		$this->render_template('admin_view/users/index', $this->data);
	}
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->render_template('admin_view/users/create', $this->data);
        }	
	}
			...
			if ($this->form_validation->run() == TRUE) {
		        ...
		        if(empty($this->input->post('password')) && empty($this->input->post('cpassword'))) {
					...
					if($this->form_validation->run() == TRUE) {
						...
						$this->render_template('admin_view/users/edit', $this->data);
			        }	
	...
	public function delete($id)
	{
		...
		if($id) {
			if($this->input->post('confirm')) {
				...
				$this->data['id'] = $id;
				$this->render_template('admin_view/users/delete', $this->data);
			}	
		}
	}
	...
	public function profile()
	{
        ...
        $this->render_template('admin_view/users/profile', $this->data);
	}
			...
			if ($this->form_validation->run() == TRUE) {
		        ...
		        if(empty($this->input->post('password')) && empty($this->input->post('cpassword'))) {
					...
					if($this->form_validation->run() == TRUE) {
						...
						$this->render_template('admin_view/users/setting', $this->data);	
			        }	
