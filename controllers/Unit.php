...
class Unit extends Admin_Controller 
{
	...
	public function index()
	{
        ...
        $this->data['allData'] = $this->model_unit->fecthAllData();
		
		$this->render_template('admin_view/settings/unit', $this->data);
	}
	...
	public function update()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	// print_r($data); exit();
        	$create = $this->model_unit->update($data);
	...
	public function delete()
	{
		...
		$id = $this->input->post('id_edit');
		$delete = $this->model_unit->delete($id);	
