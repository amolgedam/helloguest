          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="userTable" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php if($user_data): ?>                  
                    <?php $no = 1; foreach ($user_data as $k => $v): ?>
                      <tr>
                        <td><?php echo $no; ?></td>
                        ...
                        <?php if(in_array('updateUser', $user_permission) || in_array('deleteUser', $user_permission)): ?>
                          <td>
                            <?php if(in_array('updateUser', $user_permission)): ?>
                              <a href="<?php echo base_url('users/edit/'.$v['user_info']['id']) ?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Edit</a>
                            <?php endif; ?>

                            <?php if(in_array('deleteUser', $user_permission)): ?>
                              <a href="<?php echo base_url('users/delete/'.$v['user_info']['id']) ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</a>
                            <?php endif; ?>
