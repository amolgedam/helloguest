            ...
            <form role="form" action="#" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="radio">
                    <label>
                      <input type="radio" name="gender" id="male" value="male" <?php if($user_data['gender'] == 'male') {
                        echo "checked";
                      } ?>>
                      Male
                    </label>
                    <label>
                      <input type="radio" name="gender" id="female" value="female" <?php if($user_data['gender'] == 'female') {
                        echo "checked";
                      } ?>>
                      Female
                    </label>
