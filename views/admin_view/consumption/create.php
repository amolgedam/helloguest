  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-plus-square"></i>  Internal Consumption

        <!-- <small>Control panel</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url() ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Add Internal Consumption</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form role="form" action="<?php echo base_url('consumption/createConsumption') ?>" method="post">
                      <div class="tile">
                        <div class="row">
