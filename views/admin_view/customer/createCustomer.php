  ...
  <div class="col-md-12">
    ...
    <form role="form" action="<?php echo base_url('customer/createCustomer') ?>" method="post">
          <div class="tile">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <div class="form-group">
                      <label for="exampleInputEmail1">Name <span style="color:red">*</span></label>
                      <input type="text" class="form-control" name="name" value="<?php echo set_value('name'); ?>" placeholder="Enter full name">
                    </div>
                 </div>
            ...
            <a href="<?php echo base_url() ?>sales_invoice/create" class="btn btn-danger">Cancel</a>
