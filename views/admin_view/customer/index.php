  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users" aria-hidden="true"></i> Customer list
          ...
          <div class="box">
            ...
            <?php if(in_array('createCustomer', $user_permission)): ?>
              <div class="box-header">
                <a href="<?php echo base_url() ?>customer/create" class="btn btn-sm btn-primary pull-right"><i class="fa fa-plus"></i> Add New</a>
              </div>
            <?php endif; ?>
                      ...
                      <?php if(in_array('updateCustomer', $user_permission) || in_array('deleteCustomer', $user_permission)): ?>
                          ...
                          <td width="170px">
                            ...
                            <?php if(in_array('updateCustomer', $user_permission)): ?>
                              <a href="<?php echo base_url() ?>customer/update/<?php echo $rows->id ?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i>Edit</a>
                            <?php endif; ?>
            ...
            <!-- /.box-body -->
 <!-- Edit popup -->
<form role="form" action="<?php echo base_url('customer/update') ?>" method="post" id="editForm">
  <div class="modal fade" id="myModal1" role="dialog">
   ...
   <form role="form" action="<?php echo base_url('customer/delete') ?>" method="post" id="deleteForm">
