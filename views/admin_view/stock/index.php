<!-- < ?php echo "<pre>"; print_r($stockData); echo "</pre>"; exit(); ?> -->
        ...
        <div class="col-xs-12">
          ...
          <?php if(in_array('createOpeningStock', $user_permission)): ?>
              <div style="float:right">
                <a href="<?php echo base_url() ?>stock/create" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Stock</a>
              </div>
          <?php endif; ?>
                      ...
                      <?php if(in_array('updateOpeningStock', $user_permission) || in_array('deleteOpeningStock', $user_permission)): ?>
                        ...
                        <td width="240px">
                          ...
                          <?php if(in_array('updateOpeningStock', $user_permission)): ?>
                              <a href="<?php echo base_url() ?>stock/update/<?php echo $rows->products_id ?>" class="btn btn-sm btn-info">
