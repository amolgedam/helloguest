  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-plus-square"></i>  Edit Damage Stock

        <!-- <small>Control panel</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url() ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Edit Damage Stock</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              ...
              <div class="row">
  <div class="col-md-12">
  <form role="form" action="<?php echo base_url('damage_stock/updateDamage') ?>" method="post">
          ...
          <tbody>
                          <tr id="row_1">
                            <td>
                              <input type="hidden" name="product_id" data-row-id="row_1" id="id_1" class="product_1 form-control autocomplete_txt" value="<?php echo $damageData['products_id']; ?>" autocomplete="off">              
                              
                              <input list="product1"  class="form-control" onchange="getProductData(1)" placeholder="Type product name" data-row-id="row_1" id="pname_1" name="productName" required value="<?php echo $damageData['products_id'] ?>">
                              ...
                              <input type="hidden" name="pquantity" value="<?php echo $damageData['pquantity'] ?>" id="quantity_1" class="quantity_1 form-control">
                              
                            </td>
                            <td>
                              <input type="hidden" name="stockid" data-row-id="stockid_1" id="stockid_1" class="stockid_1 form-control autocomplete_txt" value="<?php echo $damageData['stock_id']; ?>" autocomplete="off">              

                              <input type="text"  name="size" id="size_1" value="<?php echo $damageData['size'] ?>" class="size_1 form-control" readonly>
                              <!-- <input type="hidden"  name="size_value[]" id="size_value_1" class="size_value_1 form-control "> -->
                            </td>
                            <td>
                              <input type="text" value="<?php echo $damageData['gst'] ?>" name="gst" id="gst_1" class="gst_1 form-control" readonly>
                              <!-- <input type="hidden"  name="gst_value[]" id="gst_value_1" class="gst_value_1 form-control "> -->
                            </td>
                            <td>
                              <input type="text" value="<?php echo $damageData['category'] ?>" name="productCategory" id="cat_1" class="cat_1 form-control" readonly>
                              <!-- <input type="hidden"  name="productCategory_value[]" id="cat_value_1" class="cat_value_1 form-control "> -->
                            </td>
                            <td>
                              <input type="text" name="productUnit" value="<?php echo $damageData['unit'] ?>" id="unit_1" class="unit_1 form-control" readonly>
                              <!-- <input type="hidden"  name="productCategory_value[]" id="unit_value_1" class="unit_value_1 form-control "> -->
                            </td> 
                            <td>
                              <input type="text" name="purchasePrice" value="<?php echo $damageData['purchase_price'] ?>" id="pprice_1" class="pprice_1 form-control" readonly>
                              <!-- <input type="hidden"  name="purchasePrice_value[]" id="pprice_value_1" class="pprice_value_1 form-control "> -->
                            </td>
                            <td>
                              <input type="text" name="salesPrice" value="<?php echo $damageData['sales_price'] ?>" id="sprice_1" class="sprice_1 form-control" readonly>
                              <!-- <input type="hidden"  name="salesPrice_value[]" id="sprice_value_1" class="sprice_value_1 form-control "> -->
                            </td>
                            <td>
                              <input type="text" name="quantity" value="<?php echo $damageData['quantity'] ?>" id="quantity_1" class="quantity_1 form-control">

                              <input type="hidden" name="oldquantity" value="<?php echo $damageData['quantity'] ?>" id="quantity_1" class="quantity_1 form-control">
          ...
          <div class="col-xs-12 col-lg-12 col-md-12 pull-left" >
            ...
            <div style="float: right;">
                  <a href="<?php echo base_url() ?>damage_stock" class="btn btn-danger">Cancel</a>
