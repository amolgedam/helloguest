  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-plus-square"></i>  Damage Stock
        ...
        <div class="col-xs-12">
           ...
           <div class="box">
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form role="form" action="<?php echo base_url('damage_stock/createDamageStock') ?>" method="post">
                      <div class="tile">
                        <div class="row">
      ...
      else
      {
         $.ajax({
                  ...
                  success:function(response) {
                    ...
                    $("#cat_"+row_id).val(response.subcategory);
