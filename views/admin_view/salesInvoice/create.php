...
<!--< ?php echo $salescode; exit; ?>-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-plus-square"></i>  Create Sales Order
...
<form role="form" action="<?php echo base_url('sales_invoice/createInvoice') ?>" method="post">
          ...
          <div class="tile">
            <div class="row">
             ...
             <div class="input-group">
                <div class="input-group-addon" ><a href="<?php echo base_url('customer/createCustomer') ?>"><i class="fa fa-plus-square" data-toggle="modal" data-target="#myModal1"></i></a></div>
                
                <input id="customerdata" name="customer" type="text" list="customerlist" class="form-control" autocomplete="off"/>
                ...
                <!--</select>-->
                 ...
                 <!-- <input  name="customer" list="customer" class="form-control" required="">
              ...
              <div class="form-group">
               <label class="control-label">Invoice No.</label> <span style="color:red;">∗</span>
                ...
                <input class="form-control" id="po_invoice_number" name="invoice_no" value="<?php echo($salescode) ?>" type="text" placeholder="Enter Purchase No." required="" readonly>
                        </div>
               </div>
             </div>
             ...
             <label for="exampleInputEmail1">Transaction Type</label> <span style="color:red;">∗</span>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                 ...
                 <label for="exampleInputEmail1">Sales Type</label> <span style="color:red;">∗</span>
                    ...
                    <!--<input list="salesman" name="salesman" class="form-control " placeholder="Type Salesman Name">-->
                    <!--<datalist id="salesman">-->
                    <!--  < ?php foreach($salesman as $rows): ?>-->
                    <!--    <option value="< ?php echo $rows->id ?>">< ?php echo $rows->name; ?></option>-->
                    <!--  < ?php endforeach; ?>-->
                    <!--</datalist>-->
                          ...
                          <tbody>
                            <tr id="row_1">
                              <td>
                                ...
                                <input list="product1"  class="form-control" onchange="getProductData(1)" placeholder="Type product name" data-row-id="row_1" id="pname_1" name="productName[]" required autocomplete="off">
                              ...
                              <td>
                                <input type="hidden" name="dbquantity[]" id="dbquantity_1" class="dbquantity_1 form-control">
                            ...
                            <tr id="row_2">
                              ...
                              <td>
                                <input type="hidden" name="dbquantity[]" id="dbquantity_2" class="dbquantity_2 form-control">
                            ...
                            <tr id="row_3">
                              ...
                              <td>
                                <input type="hidden" name="dbquantity[]" id="dbquantity_3" class="dbquantity_3 form-control">
                            ...
                            <tr id="row_4">
                              ...
                              <td>
                                <input type="hidden" name="dbquantity[]" id="dbquantity_4" class="dbquantity_4 form-control">
          ...
          <div class="form-group" style="margin-bottom:10px;">
            <label>Subtotal: &nbsp;</label>
                   <div class="input-group">
                        <div class="input-group-addon"><span class="input-group-text"><i class="fa fa-inr"></i></span></div> <input type="text" class="form-control" name="subtotal" id="subTotal" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" readonly>
            </div>
          </div>
                    <div class="form-group" style="margin-bottom:10px;">
            ...
            <label>Tax: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
            <div class="input-group ">
              <div class="input-group-addon"><span class="input-group-text"><i class="fa fa-inr"></i></span></div>              <input type="text" class="form-control" id="gsttaxamount" placeholder="Tax" onkeypress="return IsNumeric(event);" name="tax" ondrop="return false;" onpaste="return false;" readonly="">
            </div>
          </div>
            <div class="form-group" style="margin-bottom:10px;">
            <label>Total: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
          ...
          <div class="form-group" style="margin-bottom:10px;">
            ...
            <div class="input-group">
              <div class="input-group-addon"><span class="input-group-text"><i class="fa fa-inr"></i></span></div> 
              <input type="text" class="form-control" id="amt_paid" placeholder="Amount Paid" onkeyup="amountCal()" name="paid_amount" >
            </div>
          </div>
           <!--new  -->
               <div class="form-group" style="margin-bottom:10px;">
