        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div id="messages"></div>
            ...
            <?php if(in_array('createPaymentMethod', $user_permission)): ?>
              <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#addModal">Add Payment Method</button>
            <?php endif; ?>
                   ...
                   <?php $no = 1; foreach($allData as $rows): ?>
                    ...
                    <?php if(in_array('updatePaymentMethod', $user_permission) || in_array('deletePaymentMethod', $user_permission)): ?>
                      ...
                      <td>
                        ...
                        <?php if(in_array('updatePaymentMethod', $user_permission)): ?>
                        ...
                        <?php if(in_array('deletePaymentMethod', $user_permission)): ?>
...
<!-- MODAL Add-->
  <form role="form" action="<?php echo base_url('payment_method/create') ?>" method="post" id="createForm">
            ...
            <!-- <form role="form" action="< ?php echo base_url('tables/create') ?>" method="post" id="createForm"> -->
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Enter Payement Method Name" autocomplete="off" required>
                </div>
  ...
  <!-- MODAL Edit-->
  <form role="form" action="<?php echo base_url('payment_method/update') ?>" method="post" id="editForm">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="brand_name">Name</label>
                  <input type="text" class="form-control" id="name_edit" name="name_edit" placeholder="Enter Payment Method Name" autocomplete="off" required>
                </div>
  ...
  <!-- MODAL Edit-->
  <form role="form" action="<?php echo base_url('payment_method/delete') ?>" method="post" id="deleteForm">
