    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createProductUnit', $user_permission)): ?>
            <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#addModal">Add Unit</button>
          <?php endif; ?>
            ...
            <div class="box-body">
              <table id="manageTable" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Name</th>
                  <th>Status</th>
                  <?php if(in_array('updateProductUnit', $user_permission) || in_array('deleteProductUnit', $user_permission)): ?>
...
<!-- MODAL Add-->
  ...
  <!-- MODAL Edit-->
  <form role="form" action="<?php echo base_url('unit/update') ?>" method="post" id="editForm">
  ...
  <!-- MODAL Edit-->
  <form role="form" action="<?php echo base_url('unit/delete') ?>" method="post" id="deleteForm">
