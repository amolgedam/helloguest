		...
		<div class="container-login100">
			<div class="wrap-login100 myPadding">
				<div class="login100-pic js-tilt" data-tilt style=" margin-top:40px;">
					<img src="<?php echo base_url() ?>assets/images/companyimg/bombay.jpg" alt="Bombay Desi Restaurant"/>
				</div>

				<form action="<?php echo base_url('auth/login') ?>" method="post" class="login100-form validate-form">
					<span class="login100-form-title">
						Welcome to Bombay Desi Restaurant
					</span>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" style="background-color:#6565cb">
							Login
						</button>
					</div>
